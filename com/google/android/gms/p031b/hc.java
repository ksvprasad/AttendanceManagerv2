...
public interface hc extends IInterface {
    ...
    public static abstract class C1228a extends Binder implements hc {

        private static class C1566a implements hc {
            private IBinder f5017a;

            C1566a(IBinder iBinder) {
                this.f5017a = iBinder;
            }
            ...
            public String mo1162a() {
                ...
                try {
                    ...
                    this.f5017a.transact(1, obtain, obtain2, 0);
            ...
            public void mo1163b(int i) {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IInAppPurchase");
                    obtain.writeInt(i);
                    this.f5017a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void mo1164c(int i) {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IInAppPurchase");
                    obtain.writeInt(i);
                    this.f5017a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static hc m6811a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof hc)) ? new C1566a(iBinder) : (hc) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                ...
                case 2:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.purchase.client.IInAppPurchase");
                    mo1163b(parcel.readInt());
                    parcel2.writeNoException();
                    return true;
                case 3:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.purchase.client.IInAppPurchase");
                    mo1164c(parcel.readInt());
                    parcel2.writeNoException();
                    return true;
                case 1598968902:

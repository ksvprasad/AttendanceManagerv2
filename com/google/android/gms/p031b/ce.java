...
import com.google.android.gms.common.util.C1978k;
...
@id
public class ce {
    public static int m7766a(String str) {
        byte[] bytes;
        try {
        ...
        return C1978k.m11105a(bytes, 0, bytes.length, 0);
    }

    static boolean m7767a(int i) {
        return Character.isLetter(i) && (ce.m7768a(UnicodeBlock.of(i)) || ce.m7771c(i));
    }

    private static boolean m7768a(UnicodeBlock unicodeBlock) {
    ...
    public static byte[] m7769b(int i) {
    ...
    public static String[] m7770b(String str) {
        if (str == null) {
            return null;
        }
    ...
    private static boolean m7771c(int i) {

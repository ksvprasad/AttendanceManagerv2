...
public interface ds extends IInterface {
    ...
    public static abstract class C1434a extends Binder implements ds {

        private static class C1433a implements ds {
            private IBinder f4479a;

            C1433a(IBinder iBinder) {
                this.f4479a = iBinder;
            }

            public void mo1306a(dn dnVar) {
                ...
                try {
                    ...
                    this.f4479a.transact(1, obtain, obtain2, 0);
        ...
        public static ds m7975a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.formats.client.IOnCustomTemplateAdLoadedListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ds)) ? new C1433a(iBinder) : (ds) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    mo1306a(C1140a.m6395a(parcel.readStrongBinder()));

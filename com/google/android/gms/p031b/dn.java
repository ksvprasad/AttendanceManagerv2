...
public interface dn extends IInterface {
    ...
    public static abstract class C1140a extends Binder implements dn {

        private static class C1423a implements dn {
            private IBinder f4468a;
            ...
            public String mo1078a(String str) {
                ...
                try {
                    ...
                    this.f4468a.transact(1, obtain, obtain2, 0);
            ...
            public List<String> mo1079a() {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.formats.client.INativeCustomTemplateAd");
                    this.f4468a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public df mo1080b(String str) {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.formats.client.INativeCustomTemplateAd");
                    obtain.writeString(str);
                    this.f4468a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public void mo1081b() {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.formats.client.INativeCustomTemplateAd");
                    this.f4468a.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void mo1082c(String str) {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.formats.client.INativeCustomTemplateAd");
                    obtain.writeString(str);
                    this.f4468a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public String mo1065k() {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.formats.client.INativeCustomTemplateAd");
                    this.f4468a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                    String readString = obtain2.readString();
                    return readString;
                } finally {
        ...
        public static dn m6395a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.formats.client.INativeCustomTemplateAd");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof dn)) ? new C1423a(iBinder) : (dn) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            switch (i) {
                case 1:
                    ...
                    a = mo1078a(parcel.readString());
                    parcel2.writeNoException();
                    parcel2.writeString(a);
                    return true;
                case 2:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.formats.client.INativeCustomTemplateAd");
                    df b = mo1080b(parcel.readString());
                    parcel2.writeNoException();
    ...
    String mo1078a(String str);

    List<String> mo1079a();

    df mo1080b(String str);

    void mo1081b();

    void mo1082c(String str);

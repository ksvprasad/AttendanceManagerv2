...
public class C1978k {
    ...
    public static int m11105a(byte[] r6, int r7, int r8, int r9) {
        /*
    ...
    L_0x006b:
        ...
        goto L_0x0047;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.util.k.a(byte[], int, int, int):int");
    }
}

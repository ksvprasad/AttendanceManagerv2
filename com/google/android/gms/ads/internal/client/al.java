...
public interface al extends IInterface {
    ...
    public static abstract class C1077a extends Binder implements al {

        private static class C1076a implements al {
            private IBinder f3143a;
            ...
            public void mo1026a() {
                ...
                try {
                    ...
                    this.f3143a.transact(1, obtain, obtain2, 0);
            ...
            public void mo1027a(float f) {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IMobileAdsSettingManager");
                    obtain.writeFloat(f);
                    this.f3143a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void mo1028a(String str) {
                ...
                try {
                    ...
                    this.f3143a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void mo1029a(boolean z) {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f3143a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static al m6060a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof al)) ? new C1076a(iBinder) : (al) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                ...
                case 2:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IMobileAdsSettingManager");
                    mo1027a(parcel.readFloat());
                    parcel2.writeNoException();
                    return true;
                case 3:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IMobileAdsSettingManager");
                    mo1028a(parcel.readString());
                    parcel2.writeNoException();
                    return true;
                case 4:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IMobileAdsSettingManager");
                    mo1029a(parcel.readInt() != 0);
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
    ...
    void mo1027a(float f);

    void mo1028a(String str);

    void mo1029a(boolean z);
}

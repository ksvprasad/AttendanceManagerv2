...
import android.support.v4.p010b.C0305j;
import android.util.Log;
import java.util.LinkedList;
import java.util.Queue;

public final class FirebaseInstanceIdInternalReceiver extends C0305j {
    private static final Queue<Intent> f7086a = new LinkedList();
    private static final Queue<Intent> f7087b = new LinkedList();

    static int m12123a(Context context, String str, Intent intent) {
        Object obj = -1;
        switch (str.hashCode()) {
            case -842411455:
        ...
        return m12127c(context, intent2);
    }

    public static Intent m12124a() {
        return (Intent) f7086a.poll();
    }

    public static Intent m12125b(Context context, Intent intent) {
        return m12126b(context, "com.google.firebase.INSTANCE_ID_EVENT", intent);
    }

    private static Intent m12126b(Context context, String str, Intent intent) {
    ...
    private static int m12127c(Context context, Intent intent) {
        m12128d(context, intent);
        try {
            ComponentName a;
            if (context.checkCallingOrSelfPermission("android.permission.WAKE_LOCK") == 0) {
                a = C0305j.m1706a(context, intent);
            } else {
    ...
    private static void m12128d(Context context, Intent intent) {
    ...
    public void onReceive(Context context, Intent intent) {
        if (intent != null) {
            ...
            if (intent2 == null) {
                ...
                m12123a(context, intent.getAction(), intent2);
            }
        }
    }
}

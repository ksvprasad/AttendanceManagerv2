...
class ag {
    ...
    public static class C0217a implements ac, ad {
        private Builder f839a;

        public C0217a(Context context, Notification notification, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, RemoteViews remoteViews, int i, PendingIntent pendingIntent, PendingIntent pendingIntent2, Bitmap bitmap, int i2, int i3, boolean z, boolean z2, boolean z3, int i4, CharSequence charSequence4, boolean z4, String str, ArrayList<String> arrayList, Bundle bundle, int i5, int i6, Notification notification2, String str2, boolean z5, String str3) {
            ...
            while (it.hasNext()) {
                this.f839a.addPerson((String) it.next());
            }
        }
        ...
        public void mo176a(C0199a c0199a) {
            af.m1279a(this.f839a, c0199a);
        }

        public Notification mo177b() {
            return this.f839a.build();
        }
    }
}

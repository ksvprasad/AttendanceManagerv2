...
class C0028c {
    ...
    public static class C0027b {
        ...
        private C0027b(char c, float[] fArr) {
            this.f95a = c;
            this.f96b = fArr;
        }

        private C0027b(C0027b c0027b) {
            this.f95a = c0027b.f95a;
            this.f96b = C0028c.m130b(c0027b.f96b, 0, c0027b.f96b.length);
        }

        private static void m119a(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
        ...
        private static void m120a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d10 < 0.0d) {
                ...
                C0027b.m120a(path, f, f2, f3, f4, f5 * sqrt, f6 * sqrt, f7, z, z2);
                return;
            }
            d9 = Math.sqrt(d10);
            d5 *= d9;
            ...
            d = ((double) f5) * d6;
            d5 *= (double) f6;
            C0027b.m119a(path, (d * cos) - (d5 * sin), (d * sin) + (d5 * cos), (double) f5, (double) f6, (double) f, (double) f2, toRadians, d7, d4);
        }

        private static void m121a(Path path, float[] fArr, char c, char c2, float[] fArr2) {
            int i;
            float f = fArr[0];
            float f2 = fArr[1];
            float f3 = fArr[2];
            ...
            while (i2 < fArr2.length) {
                ...
                switch (c2) {
                    case 'A':
                        C0027b.m120a(path, f10, f9, fArr2[i2 + 5], fArr2[i2 + 6], fArr2[i2 + 0], fArr2[i2 + 1], fArr2[i2 + 2], fArr2[i2 + 3] != 0.0f, fArr2[i2 + 4] != 0.0f);
                        f3 = fArr2[i2 + 5];
                        f4 = fArr2[i2 + 6];
                        f6 = f7;
                        f5 = f8;
                    ...
                    case 'V':
                        ...
                        break;
                    case 'a':
                        C0027b.m120a(path, f10, f9, fArr2[i2 + 5] + f10, fArr2[i2 + 6] + f9, fArr2[i2 + 0], fArr2[i2 + 1], fArr2[i2 + 2], fArr2[i2 + 3] != 0.0f, fArr2[i2 + 4] != 0.0f);
                        f3 = f10 + fArr2[i2 + 5];
                        f4 = fArr2[i2 + 6] + f9;
                        f6 = f7;
                        f5 = f8;
        ...
        public static void m122a(C0027b[] c0027bArr, Path path) {
            float[] fArr = new float[6];
            char c = 'm';
            for (int i = 0; i < c0027bArr.length; i++) {
                C0027b.m121a(path, fArr, c, c0027bArr[i].f95a, c0027bArr[i].f96b);
                c = c0027bArr[i].f95a;
            }
        }
    }

    private static int m123a(String str, int i) {
        while (i < str.length()) {
    ...
    private static void m124a(java.lang.String r7, int r8, android.support.p002a.p003a.C0028c.C0026a r9) {
        /*
        r1 = 0;
        r5 = 1;
        r9.f94b = r1;
    ...
    private static void m125a(ArrayList<C0027b> arrayList, char c, float[] fArr) {
        arrayList.add(new C0027b(c, fArr));
    }

    public static C0027b[] m127a(String str) {
        if (str == null) {
            return null;
        }
        ...
        int i2 = 0;
        while (i < str.length()) {
            int a = C0028c.m123a(str, i);
            String trim = str.substring(i2, a).trim();
            if (trim.length() > 0) {
                C0028c.m125a(arrayList, trim.charAt(0), C0028c.m129b(trim));
            }
            i = a + 1;
            i2 = a;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            C0028c.m125a(arrayList, str.charAt(i2), new float[0]);
        }
        return (C0027b[]) arrayList.toArray(new C0027b[arrayList.size()]);
    }

    public static C0027b[] m128a(C0027b[] c0027bArr) {
        if (c0027bArr == null) {
            return null;
        }
        C0027b[] c0027bArr2 = new C0027b[c0027bArr.length];
        for (int i = 0; i < c0027bArr.length; i++) {
            c0027bArr2[i] = new C0027b(c0027bArr[i]);
        }
        return c0027bArr2;
    }

    private static float[] m129b(String str) {
        ...
        try {
            ...
            return C0028c.m130b(fArr, 0, i);
        } catch (Throwable e) {
            throw new RuntimeException("error in parsing \"" + str + "\"", e);
        }
    }

    private static float[] m130b(float[] fArr, int i, int i2) {
        if (i > i2) {
